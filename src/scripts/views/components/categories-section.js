      ...
      <div class="container">
        ...
        <div class="row g-3">
          <div class="col-lg-7 col-md-6">
            <div class="row g-3">
              <div class="col-lg-12 col-md-12 wow animate__animated animate__zoomIn" data-wow-delay="0.1s">
                <a href="/#/category" class="position-relative d-block overflow-hidden" href="/#/">
                  <img class="img-fluid" src="./img/cat-1.jpg" alt="">
                  <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                    <h5 class="m-0">Acreditated</h5>
                    <small class="text-primary">49 Schools</small>
                  </div>
                </a>
              </div>
          ...
          <div class="col-lg-5 col-md-6 wow animate__animated animate__zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
            <a href="/#/category" class="position-relative d-block h-100 overflow-hidden" href="/#/">
