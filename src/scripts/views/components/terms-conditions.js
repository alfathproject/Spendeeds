    ...
    this.innerHTML = `
      ...
      <div class="container">
        ...
        <div class="text-start">
          ...
          <!-- desc -->
          <p>
            Selamat datang di spendeeds!<br><br>
            Syarat dan ketentuan berikut menjelaskan peraturan dan ketentuan penggunaan Website Capstone Grup C22-229 dengan alamat spendeeds.com.<br><br>
            Dengan mengakses website ini, kami menganggap Anda telah menyetujui syarat dan ketentuan ini. Jangan lanjutkan penggunaan spendeeds jika Anda menolak untuk menyetujui semua syarat dan ketentuan yang tercantum di halaman ini.         
          <p>

          <!-- cookie -->
          <h3 class="mt-5">Cookie:</h3>
          <p>
            Website ini menggunakan cookie untuk mempersonalisasi pengalaman online Anda. Dengan mengakses spendeeds, Anda menyetujui penggunaan cookie yang diperlukan.<br><br>
            Cookie merupakan file teks yang ditempatkan pada hard disk Anda oleh server halaman web. Cookie tidak dapat digunakan untuk menjalankan program atau mengirimkan virus ke komputer Anda. Cookie yang diberikan telah disesuaikan untuk Anda dan hanya dapat dibaca oleh web server pada domain yang mengirimkan cookie tersebut kepada Anda.<br><br>
          ...
          <!-- lisensi -->
          <h3 class="mt-5">Lisensi:</h3>
          <p>
            Kecuali dinyatakan lain, Capstone Grup C22-229 dan/atau pemberi lisensinya memiliki hak kekayaan intelektual atas semua materi di spendeeds. Semua hak kekayaan intelektual dilindungi undang-undang. Anda dapat mengaksesnya dari spendeeds untuk penggunaan pribadi Anda sendiri dengan batasan yang diatur dalam syarat dan ketentuan ini.<br><br>
            Anda dilarang untuk:
          </p>
          <ul>
            <li>Menyalin atau menerbitkan ulang materi dari spendeeds.</li>
            <li>Menjual, menyewakan, atau mensublisensikan materi dari spendeeds.</li>
            <li>Memproduksi ulang, menggandakan, atau menyalin materi dari spendeeds.</li>
            <li>Mendistribusikan ulang konten dari spendeeds.</li>
          </ul>
          <p>
            Perjanjian ini akan mulai berlaku pada tanggal perjanjian ini.<br><br>
            Beberapa bagian website ini menawarkan kesempatan bagi pengguna untuk memposting serta bertukar pendapat dan informasi di area website tertentu. Capstone Grup C22-229 tidak akan memfilter, mengedit, memublikasikan, atau meninjau Komentar di hadapan pengguna di website. Komentar tidak mencerminkan pandangan dan pendapat Capstone Grup C22-229, agennya, dan/atau afiliasinya. Komentar mencerminkan pandangan dan pendapat individu yang memposting pandangan dan pendapatnya. Selama diizinkan oleh undang-undang yang berlaku, Capstone Grup C22-229 tidak akan bertanggung jawab atas Komentar atau kewajiban, kerugian, atau pengeluaran yang disebabkan dan/atau ditanggung sebagai akibat dari penggunaan dan/atau penempatan dan/atau penayangan Komentar di website ini.<br><br>
            Capstone Grup C22-229 berhak memantau semua Komentar dan menghapus Komentar apa pun yang dianggap tidak pantas, menyinggung, atau menyebabkan pelanggaran terhadap Syarat dan Ketentuan ini.<br><br>
          ...
          <p>
            Dengan ini Anda memberikan lisensi non-eksklusif kepada Capstone Grup C22-229 untuk menggunakan, memproduksi ulang, mengedit, dan mengizinkan orang lain untuk menggunakan, memproduksi ulang, dan mengedit Komentar Anda dalam segala bentuk, format, atau media.
          </p>

          <!-- hyperlink -->
          <h3 class="mt-5">Membuat hyperlink yang mengarah ke Konten kami:</h3>
          ...
          <p>
            Kami akan menyetujui permintaan penautan dari organisasi-organisasi tersebut jika kami memutuskan bahwa: (a) tautan tersebut tidak akan membuat kami terlihat merugikan kami sendiri atau bisnis terakreditasi kami; (b) organisasi tidak memiliki catatan negatif apa pun dengan kami; (c) keuntungan bagi kami dari keberadaan hyperlink mengkompensasi tidak adanya Capstone Grup C22-229; dan (d) tautan tersebut dalam konteks informasi sumber daya umum.<br><br>
            Organisasi-organisasi ini dapat menautkan ke halaman beranda kami selama tautan tersebut: (a) tidak menipu dengan cara apa pun; (b) tidak menyiratkan secara keliru adanya hubungan sponsor, rekomendasi, atau persetujuan dari pihak yang menautkan beserta produk dan/atau layanannya; dan (c) sesuai dengan konteks website pihak yang menautkan.<br><br>
            Jika Anda merupakan salah satu organisasi yang tercantum dalam paragraf 2 di atas dan tertarik untuk membuat tautan ke website kami, Anda harus memberitahu kami dengan mengirimkan email ke Capstone Grup C22-229. Harap cantumkan nama Anda, nama organisasi Anda, informasi kontak dan URL website Anda, daftar URL apa pun yang akan memuat tautan ke Website kami, serta daftar URL di website kami yang ingin Anda tautkan. Silakan tunggu tanggapan dari kami selama 2-3 minggu.<br><br>
          ...
          <p>
            Tidak ada penggunaan logo Capstone Grup C22-229 atau karya seni lainnya yang diizinkan untuk menautkan perjanjian lisensi merek dagang.
          </p>

          <!-- tanggung jawab -->
          <h3 class="mt-5">Tanggung jawab atas Konten:</h3>
          <p>
          ...
          <!-- kepemilikian hak -->
          <h3 class="mt-5">Pernyataan Kepemilikan Hak:</h3>
          <p>
          ...
          <!-- Penghapusan tautan -->
          <h3 class="mt-5">Penghapusan tautan dari website kami:</h3>
          <p>
            Jika Anda menemukan tautan di Website kami yang bersifat menyinggung karena alasan apa pun, Anda bebas menghubungi dan memberi tahu kami kapan saja. Kami akan mempertimbangkan permintaan untuk menghapus tautan, tetapi kami tidak berkewajiban untuk menanggapi Anda secara langsung.<br><br>
          ...
          <p>
            Batasan dan pengecualian tanggung jawab yang diatur dalam Bagian ini dan bagian lain dalam penolakan ini: (a) tunduk pada paragraf sebelumnya; dan (b) mengatur semua kewajiban yang timbul di bawah penolakan, termasuk kewajiban yang timbul dalam kontrak, dalam gugatan, dan untuk pelanggaran kewajiban hukum.<br><br>
